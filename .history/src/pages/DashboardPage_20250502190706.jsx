          ...
          content: (
            <div className="page1">
              ...
              <div className="header1">
                <img className="logo-top-left" src="/Logo_Sharely.png" alt="Sharely Logo"/>
            ...
            <div className="page5">
              <div className="whole-block">
                <div className="description-left">
                  Etiam et id tincidunt faucibus mollis a sociis pretium fermentum quis magna faucibus lacus sociis pretium fermentum quis magna faucibus lacus aevuikeb eqfjeln.
                </div>
              ...
              <div className="footer5">
                <div className="socials-icons">
                  <img src="public/facebook-icon.png" />
                  <img src="public/instagram-icon.png" />
                  <img src="public/twitter-icon.png" />
                  <img src="public/mail-icon.png" />
                </div>
