...
function App() {
  ...
  const folders = [
    ...
    { name: 'Project2', files: 37, color: '#C7AEBA' },
    { name: 'Project3', files: 50, color: '#C3CBEA' },
  ];
        ...
        <div className={`left-column ${leftVisible ? '' : 'hidden'}`}>
          ...
          <div className="left-content">
            <div className="left-part">
              ...
              <div className="sub-section_0">Sub Section 1</div>
              <div className="sub-section_0">Sub Section 2</div>
              <div className="sub-section_0">Sub Section 3</div>
            </div>
            <div className="left-part">
